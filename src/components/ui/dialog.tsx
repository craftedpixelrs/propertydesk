...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-[color:rgba(15,23,42,0.5)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className,
    )}
    {...props}
  />
...
function DialogCloseButton() {
  ...
  return (
    <DialogPrimitive.Close
      className="absolute right-3 top-3 rounded-md p-1.5 text-[var(--color-foreground-muted)] hover:bg-[var(--color-surface-inset)]"
